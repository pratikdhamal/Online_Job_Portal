...
<head>
	...
	<title>JobLoom Jobs - <?php echo "$myfname"; ?> <?php echo "$mylname"; ?></title>
		...
		<div class="main-wrapper">
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step" style="font-family: 'Roboto Condensed', sans-serif;">
						<li style="font-family: 'Roboto Condensed', sans-serif;"><a href="employees.php">All Employees</a></li>
								...
								<div class="employee-detail-wrapper">
									...
									<div class="employee-detail-header text-center">
										...
										<ul class="meta-list clearfix">
											<li style="font-family: 'Roboto Condensed', sans-serif;" style="font-family: 'Roboto Condensed', sans-serif;">
									...
									<div class="employee-detail-company-overview mt-40 clearfix">
										...
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Introduce my self</h3>
										...
										<div class="row">
											...
											<div class="col-sm-12">
												...
												<h3 style="font-family: 'Roboto Condensed', sans-serif;">Education</h3>
                                                ...
                                                ?>
												<li>
												<h5 style="font-family: 'Roboto Condensed', sans-serif;"><?php echo $row['course']; ?> </h5>
												<p class="text-muted font-italic" style="font-family: 'Roboto Condensed', sans-serif;">Level - <?php echo $row['level']; ?> , <?php echo $row['timeframe']; ?><span class="font600 text-primary"> <?php echo $row['institution']; ?></span> <?php echo $row['country']; ?></p>
												<p style="font-family: 'Roboto Condensed', sans-serif;"><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate.php?id=<?php echo $row['id']; ?>">View Certificate</a></p>
												</li>
												<?php
	                                            }
										...
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Work Experience</h3>
											<ul class="employee-detail-list">
												<?php
												require 'constants/db_config.php';
												try {
												...
												<p style="font-family: 'Roboto Condensed', sans-serif;" class="text-muted font-italic"><?php echo $row['start_date']; ?> to <?php echo $row['end_date']; ?><span class="font600 text-primary"> <?php echo $row['institution']; ?></span></p>
										...
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Training & Workshop</h3>
												<ul class="employee-detail-list">
												<?php
												require 'constants/db_config.php';
												try {
												...
												?>
                                                <p style="font-family: 'Roboto Condensed', sans-serif;"><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate-b.php?id=<?php echo $row['id']; ?>">View Certificate</a></p>
                                                <?php												
												}
										...
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Professional Qualifications</h3>
												<ul class="employee-detail-list">
												<?php
												require 'constants/db_config.php';
												try {
												...
												<p style="font-family: 'Roboto Condensed', sans-serif;"><a target="_blank" class="btn btn-primary btn-sm mb-5 mb-0-sm" href="view-certificate-c.php?id=<?php echo $row['id']; ?>">View Certificate</a></p>
												</li>
												<?php
	                                            }
											...
											<h3 style="font-family: 'Roboto Condensed', sans-serif;">Other Attachments</h3>
												<ul class="employee-detail-list">
												<?php
												require 'constants/db_config.php';
												try {
                                                ...
                                                ?>
												<li>
												<h5 style="font-family: 'Roboto Condensed', sans-serif;"><?php echo $row['title']; ?> </h5>
										...
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Language Proficiency</h3>
												<ul class="employee-detail-list">
												<?php
												require 'constants/db_config.php';
												try {
										...
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Referees</h3>
										<ul class="list-icon">
												<?php
												require 'constants/db_config.php';
												try {
