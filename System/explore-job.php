...
<head>
	...
	<title>JobLoom Jobs - <?php echo "$jobtitle"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li style="font-family: 'Roboto Condensed', sans-serif;"><a href="job-list.php">All jobs</a></li>
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="job-detail-wrapper">
								...
								<div class="job-detail-company-overview clearfix">
									...
									<h3 style="font-family: 'Roboto Condensed', sans-serif;">Company overview</h3>
									<div class="image">
										<?php 
										if ($complogo == null) {
								...
								<div class="job-detail-content mt-30 clearfix">
									...
									<h3 style="font-family: 'Roboto Condensed', sans-serif;">Job Description</h3>

									<p><?php echo "$jobdescription"; ?></p>

									
									<h3 style="font-family: 'Roboto Condensed', sans-serif;">Job Responsibilities</h3>
									
                                    <p><?php echo "$jobrespo"; ?></p>
									
									<h3 style="font-family: 'Roboto Condensed', sans-serif;">Requirements:</h3>
                                    <p><?php echo "$jobreq"; ?></p>
								...
								<div class="tab-style-01">
									...
									<ul class="nav" role="tablist">
										<li style="font-family: 'Roboto Condensed', sans-serif;" role="presentation" class="active"><h4><a href="#relatedJob1" role="tab" data-toggle="tab">More jobs from <?php echo "$compname"; ?></a></h4></li>
									</ul>
