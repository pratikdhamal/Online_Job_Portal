...
<head>
	...
	<title>JobLoom Jobs - Applicants for the job <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li style="font-family: 'Roboto Condensed', sans-serif;"><span>Applicants for the job <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 style="font-family: 'Roboto Condensed', sans-serif;" class="sorting-title">Applicants for the job <?php echo "$job_title"; ?></</h3>
						</div>
