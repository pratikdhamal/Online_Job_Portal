...
<head>
	...
	<title>Jobloom Jobs - Post Job</title>
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu">
							...
							<li>
								...
								<a style="font-family: 'Roboto Condensed', sans-serif;" href="../">Home</a>
								
							</li>
							
							<li>
								<a style="font-family: 'Roboto Condensed', sans-serif;" href="../job-list.php">Job List</a>

							</li>
							
							<li>
								<a style="font-family: 'Roboto Condensed', sans-serif;" href="../employers.php">Employers</a>
							</li>
							
							<li>
								<a  style="font-family: 'Roboto Condensed', sans-serif;" href="../employees.php">Employees</a>
							</li>
							
							<li>
								<a style="font-family: 'Roboto Condensed', sans-serif;"  href="../contact.php">Contact Us</a>
							</li>
					...
					<div class="nav-mini-wrapper">
						<ul class="nav-mini sign-in">
							<li style="font-family: 'Roboto Condensed', sans-serif;" ><a  href="../logout.php">logout</a></li>
							<li style="font-family: 'Roboto Condensed', sans-serif;" ><a href="./">Profile</a></li>
						</ul>
					</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li style="font-family: 'Roboto Condensed', sans-serif;"><a href="../">Home</a></li>
						<li style="font-family: 'Roboto Condensed', sans-serif;"><a ><?php echo "$compname"; ?></a></li>
						<li style="font-family: 'Roboto Condensed', sans-serif;"><span>Post a Job</span></li>
					</ol>
							...
							<div class="col-sm-5 col-md-4">
								...
								<div class="company-detail-sidebar">
									...
									<ul class="meta-list clearfix">
										<li>
											<h4 style="font-family: 'Roboto Condensed', sans-serif;" class="heading">Established In:</h4>
											<?php echo "$esta"; ?>
										</li>
										<li>
											<h4 style="font-family: 'Roboto Condensed', sans-serif;" class="heading">Type:</h4>
											<?php echo "$mytitle"; ?>
										</li>
										<li>
											<h4 style="font-family: 'Roboto Condensed', sans-serif;" class="heading">People:</h4>
											<?php echo "$mypeople"; ?>
										</li>
										<li>
											<h4 style="font-family: 'Roboto Condensed', sans-serif;" class="heading">Website: </h4>
											<a target="_blank" href="https://<?php echo "$myweb"; ?>"><?php echo "$myweb"; ?></a>
										</li>
										<li>
											<h4 style="font-family: 'Roboto Condensed', sans-serif;" class="heading">Email: </h4>
											<?php echo "$mymail"; ?>
										</li>
									...
									<a style="font-family: 'Roboto Condensed', sans-serif;" href="./" class="btn btn-primary mt-5"><i class="fa fa-pencil-square-o mr-5"></i>Edit</a>
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-company-overview  mt-0 clearfix">
										...
										<div class="section-title-02">
											<h3 style="font-family: 'Roboto Condensed', sans-serif;" class="text-left">Post a Job</h3>
										</div>
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-8 col-md-8">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Job Title</label>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">City</label>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Job Category</label>
											    ...
											    <div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Closing Date</label>
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Job Type:</label>
														<select style="font-family: 'Roboto Condensed', sans-serif;"  name="jobtype" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
												...
												<div class="col-xss-12 col-xs-6 col-sm-6 col-md-4">
													...
													<div class="form-group mb-20">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Experience:</label>
														<select style="font-family: 'Roboto Condensed', sans-serif;" name="experience" required class="selectpicker show-tick form-control" data-live-search="false" data-selected-text-format="count > 3" data-done-button="true" data-done-button-text="OK" data-none-selected-text="All">
															<option value="" selected >Select</option>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Job Description</label>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Job Responsibilies</label>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Requirements</label>
												...
												<div class="col-sm-6 mt-30">
													<button style="font-family: 'Roboto Condensed', sans-serif;" type="submit"  onclick = "validate(this)" class="btn btn-primary btn-lg">Post Your Job</button>
												</div>
