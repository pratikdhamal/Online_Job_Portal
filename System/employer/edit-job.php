											...
											<?php include 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<select style="font-family: 'Roboto Condensed', sans-serif;" name="country" required class="selectpicker show-tick form-control" data-live-search="true">
												...
												<div class="col-sm-6 mt-30">
													<button style="font-family: 'Roboto Condensed', sans-serif;"  type="submit"  class="btn btn-primary btn-lg">Save Changes</button>
												</div>
