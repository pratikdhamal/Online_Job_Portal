...
<head>
	...
	<title>JobLoom Jobs - Company Profile</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li style="font-family: 'Roboto Condensed', sans-serif;"><a href="../">JobLoom Jobs</a></li>
						<li style="font-family: 'Roboto Condensed', sans-serif;"><span>Profile</span></li>
					</ol>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a style="font-family: 'Roboto Condensed', sans-serif;" href="post-job.php" class="btn btn-primary btn-sm btn-inverse">Post a Job</a>
										
									</div>
									
									<ul class="admin-user-menu clearfix">
										<li style="font-family: 'Roboto Condensed', sans-serif;"  class="active">
											<a href="./"><i class="fa fa-user"></i> Profile</a>
										</li>
										<li style="font-family: 'Roboto Condensed', sans-serif;" class="">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 style="font-family: 'Roboto Condensed', sans-serif;">Profile</h2>
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
											...
											<div class="row gap-20">
												...
												<div class="col-sm-12 col-md-8">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Company Name</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Established In</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Type</label>
												...
												<div class="form-group">
													...
													<div class="col-sm-6 col-md-4">
														<label style="font-family: 'Roboto Condensed', sans-serif;">People</label>
													...
													<div class="col-sm-6 col-md-4">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Website</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">City/town</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Street</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Zip Code</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Country</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Phone Number</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Email Address</label>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Company background</label>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Services</label>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Expertise</label>
												...
												<div class="col-sm-12 mt-10">
													<button style="font-family: 'Roboto Condensed', sans-serif;" type="submit" class="btn btn-primary">Save</button>
													<button style="font-family: 'Roboto Condensed', sans-serif;" type="reset" class="btn btn-warning">Cancel</button>
												</div>
										...
										<div class="form-group bootstrap3-wysihtml5-wrapper">
										<label style="font-family: 'Roboto Condensed', sans-serif;">Company Logo</label>
										...
										<div class="col-sm-12 mt-10">
										<button  style="font-family: 'Roboto Condensed', sans-serif;" type="submit" class="btn btn-primary">Update</button>
										<?php 
										if ($logo == null) {
