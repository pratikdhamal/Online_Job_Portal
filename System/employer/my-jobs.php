...
<head>
	...
	<title>JobLoom Jobs - My Jobs</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li style="font-family: 'Roboto Condensed', sans-serif;"><a href="../">Bwire Jobs</a></li>
						<li style="font-family: 'Roboto Condensed', sans-serif;"><span>My Jobs</span></li>
					</ol>
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<ul class="admin-user-menu clearfix">
										<li >
											<a style="font-family: 'Roboto Condensed', sans-serif;" href="./"><i class="fa fa-user"></i> Profile</a>
										</li>
										<li class="">
										<a style="font-family: 'Roboto Condensed', sans-serif;" href="change-password.php"><i class="fa fa-key"></i> Change Password</a>
										</li>
			
										<li>
											<a style="font-family: 'Roboto Condensed', sans-serif;" href="../company.php?ref=<?php echo "$myid"; ?>"><i class="fa fa-briefcase"></i> Company Overview</a>
										</li>
										<li  class="active">
											<a style="font-family: 'Roboto Condensed', sans-serif;" href="my-jobs.php"><i class="fa fa-bookmark"></i> Posted Jobs</a>
										</li>
										<li>
											<a style="font-family: 'Roboto Condensed', sans-serif;" href="../logout.php"><i class="fa fa-sign-out"></i> Logout</a>
										</li>
									</ul>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title">
										...
										<h2 style="font-family: 'Roboto Condensed', sans-serif;">Posted Jobs</h2>
									...
									<?php
                                        ...
                                        foreach($result as $row)
                                        {
										   ...
										   ?>
											...
											<p style="font-family: 'Roboto Condensed', sans-serif;" class="date text-muted font12 font-italic">Deadline - <?php echo "$deadline"; ?></p>
											</div>
											...
											<a style="font-family: 'Roboto Condensed', sans-serif;" target="_blank" href="view-applicants.php?jobid=<?php echo $row['job_id']; ?>">Applicants</a>
											<a style="font-family: 'Roboto Condensed', sans-serif;" href="edit-job.php?jobid=<?php echo $row['job_id']; ?>">Edit Job</a>
