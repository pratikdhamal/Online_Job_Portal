...
<head>
	...
	<title>JobLoom Jobs - Employees</title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li style="font-family: 'Roboto Condensed', sans-serif;"><span>Employees</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 style="font-family: 'Roboto Condensed', sans-serif;" class="sorting-title">Employees</h3>
						</div>
								...
								?>
									...
									<div class="employee-grid-item">
										...
										<a target="_blank" href="employee-detail.php?empid=<?php echo $row['member_no']; ?>" class="clearfix">
											...
											<div style="font-family: 'Roboto Condensed', sans-serif;" class="content">
											
												<h4 style="font-family: 'Roboto Condensed', sans-serif;"><?php echo $row['first_name'] ?> <?php echo $row['last_name'] ?></h4>
												<p class="location"><i class="fa fa-map-marker"></i> <?php echo $row['country'] ?></p>
												
												<h6 style="font-family: 'Roboto Condensed', sans-serif;" class="text-primary">Education : <?php echo $row['education'] ?></h6>
												
                                                <h6 style="font-family: 'Roboto Condensed', sans-serif;" class="text-primary"><?php echo $row['title'] ?></h6>
