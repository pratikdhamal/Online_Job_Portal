...
<head>
	...
	<title>JobLoom - Job Portal</title>
			...
			<nav class="navbar navbar-default navbar-fixed-top navbar-sticky-function">
				...
				<div class="container">
					...
					<div id="navbar" class="navbar-nav-wrapper navbar-arrow">
						...
						<ul class="nav navbar-nav" id="responsive-menu" style="font-family: 'Roboto Condensed', sans-serif;">
					...
					<div class="nav-mini-wrapper">
						<ul class="nav-mini sign-in" style="font-family: 'Roboto Condensed', sans-serif; font-size: 20px;">
						<?php
						if ($user_online == true) {
						print '
		...
		<div class="main-wrapper">
			...
			<div class="hero" style="background-image:url('images/hero-header/1.jpg');">
				<div class="container" style="font-family: 'Roboto Condensed', sans-serif;">
					...
					<h1 style="font-family: 'Roboto Condensed', sans-serif;">your bright future starts here now</h1>
					<p style="color: black;">Finding your next job or career on JobLooms</p>
						...
						<div class="row">
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5 style="font-family: 'Roboto Condensed', sans-serif;">01 / Search for jobs</h5>
									</div>
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5 style="font-family: 'Roboto Condensed', sans-serif;">02 / Apply a Job</h5>
									</div>
							...
							<div class="col-sm-4">
								...
								<div class="process-item clearfix">
									...
									<div class="content">
										<h5 style="font-family: 'Roboto Condensed', sans-serif;">03 / Start Working</h5>
									</div>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<br><h2 style="font-family: 'Roboto Condensed', sans-serif; text-decoration: none;">Our recruiters</h2>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<h2 style="font-family: 'Roboto Condensed', sans-serif;">Latest Jobs</h2>
