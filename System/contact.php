...
<head>
	...
	<title>JobLoom Jobs - Contact Us</title>
		...
		<header id="header">
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-header">
					...
					<h4 style="font-family: 'Roboto Condensed', sans-serif;" class="modal-title text-center">Create your account for free</h4>
				</div>
				...
				<div class="modal-body">
					...
					<div class="row gap-20">
						...
						<div class="col-sm-6 col-md-6">
							<a style="font-family: 'Roboto Condensed', sans-serif;" href="register.php?p=Employer" class="btn btn-facebook btn-block mb-5-xs">Register as Employer</a>
						</div>
						<div class="col-sm-6 col-md-6">
							<a style="font-family: 'Roboto Condensed', sans-serif;" href="register.php?p=Employee" class="btn btn-facebook btn-block mb-5-xs">Register as Employee</a>
						</div>
				...
				<div class="modal-footer text-center">
					<button style="font-family: 'Roboto Condensed', sans-serif;" type="button" data-dismiss="modal" class="btn btn-primary btn-inverse">Close</button>
				</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list">
						...
						<li style="font-family: 'Roboto Condensed', sans-serif;"><span>Contact Us</span></li>
					</ol>
					...
					<div class="row">
						...
						<div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
							...
							<div class="section-title">
								...
								<h2 style="font-family: 'Roboto Condensed', sans-serif;">Contact us for help</h2>
					...
					<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label style="font-family: 'Roboto Condensed', sans-serif;" for="inputName">Your Name <span class="font10 text-danger">(required)</span></label>
											<input style="font-family: 'Roboto Condensed', sans-serif;" id="inputName" name="fullname" type="text" class="form-control" data-error="Your name is required" required>
									...
									<div class="col-sm-6">
										...
										<div class="form-group">
											<label style="font-family: 'Roboto Condensed', sans-serif;" for="inputEmail">Your Email <span class="font10 text-danger">(required)</span></label>
											<input style="font-family: 'Roboto Condensed', sans-serif;" id="inputEmail" name="email" type="email" class="form-control" data-error="Your email is required and must be a valid email address" required>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-sm-12">
										...
										<div class="form-group">
											<label style="font-family: 'Roboto Condensed', sans-serif;" for="inputMessage">Message <span class="font10 text-danger">(required)</span></label>
											<textarea style="font-family: 'Roboto Condensed', sans-serif;" id="inputMessage" name="message" class="form-control" rows="8" data-minlength="50" data-error="Your message is required and must not less than 50 characters" required></textarea>
											<div class="help-block with-errors"></div>
										</div>
									...
									<div class="col-sm-12 text-right">
										<button style="font-family: 'Roboto Condensed', sans-serif;" type="submit" class="btn btn-primary mt-5">Send Message</button>
									</div>
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li style="font-family: 'Roboto Condensed', sans-serif;">
										<h5 style="font-family: 'Roboto Condensed', sans-serif;">Address</h5>
										<address> Bibwewadi, <br/> Pune, <br/>Maharashtra</address>
								</li>
								<li style="font-family: 'Roboto Condensed', sans-serif;">
										<h5 style="font-family: 'Roboto Condensed', sans-serif;">Email</h5><a href="mailto:nightingale.nath2@gmail.com">pratikdhamal18@gmail.com</a>
								</li>
								<li style="font-family: 'Roboto Condensed', sans-serif;">
										<h5 style="font-family: 'Roboto Condensed', sans-serif;">Phone Number</h5><a href="tel:+233 546 607 474">+91 8421994683</a>
								</li>

								<li style="font-family: 'Roboto Condensed', sans-serif;">
										<h5 style="font-family: 'Roboto Condensed', sans-serif;">Social Networks</h5>
