...
<head>
	...
	<title>JobLoom - <?php echo "$title"; ?></title>
				...
				<div class="container">
					...
					<form action="job-list.php" method="GET" autocomplete="off">
						...
						<div class="second-search-result-inner">
							<span style="font-family: 'Roboto Condensed', sans-serif;" class="labeling">Search a job</span>
							<div class="row">
							
								<div style="font-family: 'Roboto Condensed', sans-serif;" class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										<select style="font-family: 'Roboto Condensed', sans-serif;" class="form-control" name="category" required/>
								...
								<div class="col-xss-12 col-xs-6 col-sm-6 col-md-5">
									<div class="form-group form-lg">
										<select style="font-family: 'Roboto Condensed', sans-serif;" class="form-control" name="country" required/>
								...
								<div class="col-xss-12 col-xs-6 col-sm-4 col-md-2">
									<button style="font-family: 'Roboto Condensed', sans-serif;" name="search" value="✓" type="submit" class="btn btn-block">Search</button>
								</div>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						...
						<li style="font-family: 'Roboto Condensed', sans-serif;"><span><?php echo "$title"; ?></span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 style="font-family: 'Roboto Condensed', sans-serif;" class="sorting-title"><?php echo "$title"; ?></h3>
						</div>
										...
										<div class="content">
											...
											<div class="job-item-list-bottom">
												...
												<div class="row">
													...
													<div class="col-sm-5 col-md-4">
														<a style="font-family: 'Roboto Condensed', sans-serif;" target="_blank" href="explore-job.php?jobid=<?php echo $row['job_id']; ?>" class="btn btn-primary">View This Job</a>
													</div>
