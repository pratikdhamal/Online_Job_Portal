						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="image">	
										...
										<h4 style="font-family: 'Roboto Condensed', sans-serif;"><?php echo "$myfname"; ?> <?php echo "$mylname"; ?></h4>
										<p style="font-family: 'Roboto Condensed', sans-serif;" class="user-role"><?php echo "$mytitle"; ?></p>
										
									</div>
									
									<div class="admin-user-action text-center">
									
										<a style="font-family: 'Roboto Condensed', sans-serif;" target="_blank" href="my_cv" class="btn btn-primary btn-sm btn-inverse">View my CV</a>
										
									</div>
									
									<ul class="admin-user-menu clearfix" style="font-family: 'Roboto Condensed', sans-serif;">
										<li class="active">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<div class="admin-section-title" style="font-family: 'Roboto Condensed', sans-serif;">
									...
									<form class="post-form-wrapper" action="app/update-profile.php" method="POST" autocomplete="off">
											...
											<?php require 'constants/check_reply.php'; ?>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">First Name</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Last Name</label>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Born</label>
														<div class="row gap-5">
															<div class="col-xs-3 col-sm-3">
																<select style="font-family: 'Roboto Condensed', sans-serif;" name="date" required class="selectpicker form-control" data-live-search="false">
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Email</label>
												...
												<div class="form-group">
													...
													<div class="col-sm-12">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Education Level</label>
													</div>
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														<label style="font-family: 'Roboto Condensed', sans-serif;">Gender</label>
												...
												<div class="col-sm-12 col-md-12">
													...
													<div class="form-group bootstrap3-wysihtml5-wrapper">
														<label style="font-family: 'Roboto Condensed', sans-serif;">About me</label>
												...
												<div class="col-sm-12 mt-10">
													...
													<button style="font-family: 'Roboto Condensed', sans-serif;" type="reset" class="btn btn-primary btn-inverse">Cancel</button>
												</div>
										...
										<div class="form-group bootstrap3-wysihtml5-wrapper">
										<label style="font-family: 'Roboto Condensed', sans-serif;">Display Image</label>
