	...
	<div class="container-wrapper">
		...
		<header id="header">
			...
			<div id="registerModal" class="modal fade login-box-wrapper" tabindex="-1" style="display: none;" data-backdrop="static" data-keyboard="false" data-replace="true">
				...
				<div class="modal-header" style="font-family: 'Roboto Condensed', sans-serif;">
					...
					<div class="row">
						...
						<div class="col-md-10 col-md-offset-1">
							...
							<div class="row">
                                ...
                                <h4 class="modal-title text-center" style="font-family: 'Roboto Condensed', sans-serif;">Access your account</h4>
                                </div>
                                ...
                                <input style="font-family: 'Roboto Condensed', sans-serif;" class="form-control" placeholder="Enter your password" name="password" required type="password"> 
                                </div>
								...
								<a data-toggle="modal" onclick = "reset_text()" href="#forgotPasswordModal" style="font-family: 'Roboto Condensed', sans-serif;">Forgot password?</a> 
							    </div>
						      </div>	
...
<div class="modal-footer text-center">
<button type="submit" class="btn btn-primary" style="font-family: 'Roboto Condensed', sans-serif;">Login</button>
</div>
				...
				<div class="modal-body">
					<div class="row gap-20">
						...
						<div class="col-sm-12 col-md-12">
							<div class="login-box-box-action" style="font-family: 'Roboto Condensed', sans-serif;">
