...
<head>
	...
	<title>JobLoom Jobs - <?php echo "$compname"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li style="font-family: 'Roboto Condensed', sans-serif;"><a href="employers.php">Employers</a></li>
							...
							<div class="col-md-10 col-md-offset-1">
								...
								<div class="company-detail-wrapper">
									...
									<div class="company-detail-header text-center">
										...
										<div class="image" style="font-family: 'Roboto Condensed', sans-serif;">
										<?php 
										if ($complogo == null) {
										...
										<h2 style="font-family: 'Roboto Condensed', sans-serif;" class="heading mb-15"><?php echo "$compname"; ?></h2>
									
										<p style="font-family: 'Roboto Condensed', sans-serif;" class="location"><i class="fa fa-map-marker"></i> <?php echo "$compzip"; ?> <?php echo "$compcity"; ?>. <?php echo "$compstreet"; ?>, <?php echo "$compcountry"; ?> <span class="mh-5">|</span> <i class="fa fa-phone"></i> <?php echo "$compphone"; ?></p>
										
										<ul style="font-family: 'Roboto Condensed', sans-serif;" class="meta-list clearfix">
											<li style="font-family: 'Roboto Condensed', sans-serif;">
									...
									<div class="company-detail-company-overview clearfix">
										...
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Company background</h3>
										
										<p><?php echo "$compbout"; ?></p>

										
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Services</h3>
										
										<p><?php echo "$compserv"; ?></p>
										
										<h3 style="font-family: 'Roboto Condensed', sans-serif;">Expertise</h3>
									...
									<div class="section-title mb-40">
										...
										<h4 class="text-left" style="font-family: 'Roboto Condensed', sans-serif;">jobs offered at <?php echo "$compname"; ?></h4>
